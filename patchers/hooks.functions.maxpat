    ...
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1267.0, 658.0, 77.0, 22.0 ],
                    "text": "r #0-name"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1267.0, 681.0, 72.0, 22.0 ],
                    "text": "prepend set"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1240.0, 711.0, 53.0, 22.0 ],
                    "text": "prepend"
                }
            },
            {
                "box": {
                    "code": "inlets = 1;\r\noutlets = 1;\r\n\r\n\r\n// Get the info of a parameter by its name\r\nfunction bang()\r\n{\r\n    var p = this.patcher.parentpatcher\r\n    var toggle = p.getnamed(\"toggle\");\r\n    if (toggle) outlet(0, toggle.getvalueof())\r\n    if (!toggle) outlet(0, 0)\r\n    \r\n}\r\n",
                    "filename": "none",
                    "fontface": 0,
                    "fontname": "<Monospaced>",
                    "fontsize": 12.0,
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1240.0, 483.0, 362.0, 176.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1244.0, 31.0, 95.0, 22.0 ],
                    "text": "random-function"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1152.0, 407.0, 125.0, 22.0 ],
                    "text": "s hooks/receive-detail"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "bang", "int" ],
                    "patching_rect": [ 982.0, 303.0, 32.0, 22.0 ],
                    "text": "t b 3"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 982.0, 161.0, 146.0, 22.0 ],
                    "text": "hooks.name set get-detail"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 982.0, 191.0, 19.0, 22.0 ],
                    "text": "r"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1152.0, 79.0, 61.0, 22.0 ],
                    "text": "getinfo $1"
                }
            },
            {
                "box": {
                    "code": "inlets = 1;\r\noutlets = 1;\r\n\r\n\r\n// Get the info of a parameter by its name\r\nfunction getinfo()\r\n{\r\n    var args = arrayfromargs(arguments);\r\n    var p = this.patcher.parentpatcher\r\n    var paramInfo = p.getnamed(args[0]);\r\n    if (!paramInfo) return\r\n    var type = paramInfo.getattr(\"annotation_name\")\r\n    if (type !== \"toggle\" && paramInfo.getattr(\"max\") === \"<none>\") return\r\n    if (type !== \"toggle\" && paramInfo.getattr(\"min\") === \"<none>\") return\r\n    outlet(0, [type, args[0], paramInfo.getattr(\"min\"), paramInfo.getattr(\"max\"), paramInfo.getvalueof()])\r\n}\r\n",
                    "filename": "none",
                    "fontface": 0,
                    "fontname": "<Monospaced>",
                    "fontsize": 12.0,
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1152.0, 109.0, 464.0, 284.0 ],
                    "saved_object_attributes": {
                        "parameter_enable": 0
                    }
                }
            },
            {
                "box": {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "int" ],
                                    "patching_rect": [ 206.0, 174.0, 29.5, 22.0 ],
                                    "text": "+ 1"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 174.5, 321.0, 29.5, 22.0 ],
                                    "text": "$1"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 239.0, 321.0, 29.5, 22.0 ],
                                    "text": "$2"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 2,
                                    "outlettype": [ "", "" ],
                                    "patching_rect": [ 239.0, 283.0, 29.5, 22.0 ],
                                    "text": "t l l"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 2,
                                    "outlettype": [ "", "" ],
                                    "patching_rect": [ 206.0, 236.0, 52.0, 22.0 ],
                                    "text": "gate 2 1"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "int" ],
                                    "patching_rect": [ 206.0, 147.0, 29.5, 22.0 ],
                                    "text": "> 1"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 2,
                                    "outlettype": [ "", "" ],
                                    "patching_rect": [ 195.5, 78.0, 29.5, 22.0 ],
                                    "text": "t l l"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 2,
                                    "outlettype": [ "", "" ],
                                    "patching_rect": [ 206.0, 119.0, 37.0, 22.0 ],
                                    "text": "zl.len"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 195.5, 18.0, 30.0, 30.0 ]
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 174.5, 413.0, 30.0, 30.0 ]
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 206.0, 413.0, 30.0, 30.0 ]
                                }
                            }
                        ],
                        "lines": [
                            ...
                            },
                            {
                                "patchline": {
                                    ...
                                    "midpoints": [ 205.0, 221.0, 248.5, 221.0 ],
                                    "source": [ "obj-43", 0 ]
                                }
                            },
                            {
                            ...
                            },
                            {
                                "patchline": {
                                    ...
                                    "midpoints": [ 259.0, 313.0, 184.0, 313.0 ],
                                    "source": [ "obj-59", 1 ]
                                }
                            },
                            {
                                "patchline": {
                                    "destination": [ "obj-100", 0 ],
                                    "midpoints": [ 248.5, 377.5, 215.5, 377.5 ],
                                    "source": [ "obj-62", 0 ]
                                }
                            },
                            {
                    ...
                    "patching_rect": [ 454.0, 79.0, 166.0, 22.0 ],
                    "text": "p gate-name"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 527.5, 259.0, 29.5, 22.0 ],
                    "text": "-"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 527.5, 231.0, 86.0, 22.0 ],
                    "text": "r hooks/legacy"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 454.0, 289.0, 197.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1240.0, 750.0, 126.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1240.0, 447.0, 82.0, 22.0 ],
                    "text": "r hooks/probe"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 1064.0, 525.0, 156.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1064.0, 489.0, 97.0, 22.0 ],
                    "text": "r #0-name"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1045.0, 607.0, 49.0, 22.0 ],
                    "text": "forward"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 3,
                    "outlettype": [ "", "", "" ],
                    "patching_rect": [ 794.0, 384.0, 42.0, 22.0 ],
                    "text": "gate 3"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 454.0, 38.0, 30.0, 30.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 509.0, 495.0, 57.0, 36.0 ],
                    "text": "test/haha"
                }
            },
            {
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-42", 0 ],
                    "midpoints": [ 826.5, 416.0, 1137.0, 416.0, 1137.0, 69.0, 1161.5, 69.0 ],
                    "source": [ "obj-14", 2 ]
                }
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 815.0, 428.5, 1054.5, 428.5 ],
                    "source": [ "obj-14", 1 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-46", 0 ],
                    "midpoints": [ 70.16666666666666, 141.5, 991.5, 141.5 ],
                    "order": 0,
                    "source": [ "obj-34", 1 ]
                }
            },
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 475.5, 469.0, 556.5, 469.0 ],
                    "order": 0,
                    "source": [ "obj-38", 1 ]
                }
            },
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-52", 0 ],
                    "midpoints": [ 1073.5, 578.0191024697951, 1054.5, 578.0191024697951 ],
                    "source": [ "obj-47", 0 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-13", 0 ],
                    "midpoints": [ 991.5, 357.0, 652.5, 357.0 ],
                    "source": [ "obj-68", 0 ]
                }
            },
            {
                "patchline": {
                    "destination": [ "obj-14", 0 ],
                    "midpoints": [ 1004.5, 354.5, 803.5, 354.5 ],
                    "source": [ "obj-68", 1 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 1036.5, 369.5, 826.5, 369.5 ],
                    "source": [ "obj-78", 0 ]
                }
            },
            {
