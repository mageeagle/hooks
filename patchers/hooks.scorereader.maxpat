{
    "patcher": {
        ...
        "classnamespace": "box",
        "rect": [ 34.0, 77.0, 868.0, 802.0 ],
        "openinpresentation": 1,
        "description": "Reads and Sends line formatted messages from a Hooks formatted Score",
        "digest": "Reads and Sends line formatted messages from a Hooks formatted Score",
        "tags": "hooks",
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 536.1842054128647, 1286.1841982603073, 29.5, 22.0 ],
                    "text": "ms"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 536.1842054128647, 1257.2368301153183, 143.0, 22.0 ],
                    "text": "r hooks/score/script-reset"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 748.0, 312.5520475101471, 115.0, 22.0 ],
                    "text": "s hooks/score/score"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 594.7796742916107, 339.3494063615799, 129.0, 22.0 ],
                    "text": "s hooks/score/duration"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 698.0, 339.3494063615799, 179.0, 22.0 ],
                    "text": "s hooks/score/playback-position"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1163.8297789096832, 1110.1063750386238, 163.0, 22.0 ],
                    "text": "s hooks/score/pauseResume"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1271.9669270515442, 645.3220357894897, 179.0, 22.0 ],
                    "text": "s hooks/score/playback-position"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1421.7169270515442, 645.3220357894897, 147.0, 22.0 ],
                    "text": "s hooks/score/time-format"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 413.055593, 935.8488584709168, 145.0, 22.0 ],
                    "text": "r hooks/score/time-format"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1060.180997950073, 645.3220357894897, 134.0, 22.0 ],
                    "text": "s hooks/score/reader-in"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1169.577094078064, 645.3220357894897, 109.0, 22.0 ],
                    "text": "s hooks/score/start"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 785.8018137216568, 882.3220357894897, 177.0, 22.0 ],
                    "text": "r hooks/score/playback-position"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 897.66701567173, 645.3220357894897, 115.0, 22.0 ],
                    "text": "s hooks/score/score"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 955.8699490290337, 645.3220357894897, 129.0, 22.0 ],
                    "text": "s hooks/score/duration"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1233.3728212714195, 825.29665350914, 113.0, 22.0 ],
                    "text": "r hooks/score/score"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1135.315796, 936.0, 141.0, 22.0 ],
                    "text": "tr hooks/score/start reset"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 50.499835729599, 93.0, 134.0, 22.0 ],
                    "text": "s hooks/score/clear-coll"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1111.1809979500733, 565.1999967694283, 109.0, 22.0 ],
                    "text": "s hooks/score/start"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 394.00474707896046, 1145.3220357894897, 127.0, 22.0 ],
                    "text": "r hooks/score/duration"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 376.8233735561371, 239.66385302305207, 145.0, 22.0 ],
                    "text": "s hooks/score/script-reset"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 556.7796742916107, 984.8354394805431, 143.0, 22.0 ],
                    "text": "r hooks/score/script-reset"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 167.8872921514511, 177.83807947158812, 134.0, 22.0 ],
                    "text": "s hooks/score/clear-coll"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 785.8000152111053, 1296.0656832098957, 134.0, 22.0 ],
                    "text": "s hooks/score/reader-in"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "fontsize": 12.0,
                    "id": "obj-17",
                    "items": [ "test/example-filter", ",", "hi/example-filter" ],
                    "maxclass": "chooser",
                    "multiselect": 1,
                    "numinlets": 1,
                    "numoutlets": 6,
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 947.4000141620636, 422.088108985424, 134.0, 22.0 ],
                    "text": "s hooks/score/reader-in"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1013.2094347697373, 565.1999967694283, 80.0, 22.0 ],
                    "text": "s hooks/reset"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 897.66701567173, 565.1999967694283, 134.0, 22.0 ],
                    "text": "s hooks/score/clear-coll"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1095.3009157180786, 271.1914136505127, 134.0, 22.0 ],
                    "text": "s hooks/score/reader-in"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 199.50551393508908, 331.3494063615799, 132.0, 22.0 ],
                    "text": "r hooks/score/clear-coll"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 149.82337355613708, 117.0, 132.0, 22.0 ],
                    "text": "r hooks/score/reader-in"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 120.499835729599, 433.2448579263687, 107.0, 22.0 ],
                    "text": "r hooks/score/start"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "text": ";\r\nhi/example-filter/toggle 1 0 1 0 1 0"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 50.499835729599, 56.999993681907654, 78.0, 22.0 ],
                    "text": "r hooks/reset"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 149.82337355613708, 221.98341937780378, 243.0, 22.0 ],
                    "saved_object_attributes": {
                        "autostart": 0,
                        "defer": 0,
                        "watch": 1
                    },
                    "text": "node.script hooks.scoreReader.js @watch 1",
                    "textfile": {
                        "filename": "hooks.scoreReader.js",
                        "flags": 0,
                        "embed": 0,
                        "autowatch": 1
                    }
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 383.3233735561371, 252.71568277478218, 604.2796742916107, 252.71568277478218 ],
                    "order": 0,
                    "source": [ "obj-122", 1 ]
                }
            },
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 1144.815796, 1090.9311463057993, 1173.3297789096832, 1090.9311463057993 ],
                    "order": 0,
                    "source": [ "obj-142", 0 ]
                }
            },
